...
namespace BookCatalog.ApiService
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public BooksController(IBookRepository bookRepository,IPublisherRepository publisherRepository,IGenreRepository genreRepository,IAuthorRepository authorRepository, ILogger<BooksController> logger, IMapper mapper)
        {
            try
            {
        ...
        public async Task<ActionResult<IEnumerable<BookDTO>>> GetBooks()
        {
            ...
            try
            {
                ...
                return Ok(_mapper.Map<List<BookDTO>>(await _bookRepository.GetAll(b => b.Authors, b => b.Publisher, b => b.Genres)));
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<BookDTO>> GetBook(Guid id)
        {
            try
            {
                ...
                var book = _mapper.Map<BookDTO>(await _bookRepository.GetById(id, b => b.Authors, b => b.Publisher, b => b.Genres));
        ...
        public async Task<IActionResult> PutBook([FromBody] BookDTO book)
        {
            ...
            {
                // logging an error if there is an exception
                _logger.LogError(ex, LoggingStrings.ErrorGeneralMethod("updating book (API)", null, book.Id));
                return StatusCode(500, "An unexpected error occurred. Please try again later.");
            }
        }
