...
public class BooksStatistics : ControllerBase
{

    private readonly IBookRepository _bookRepository;
    private readonly ILogger<BooksStatistics> _logger;
    private readonly IMapper _mapper;


    public BooksStatistics(IBookRepository bookRepository, ILogger<BooksStatistics> logger, IMapper mapper)
    {
        try
        {
        ...
        catch (Exception)
        {
            if (_logger != null)
            {
                ...
                _logger.LogError(LoggingStrings.ErrorGeneralMethod($"creating {nameof(BooksStatistics)}"));
            }
            throw;
        }
    }
    ...
    public async Task<IActionResult> Search([FromBody] string query)
    {
        try
        {
            ...
            {
                return Ok(_mapper.Map<BookDTO>(await _bookRepository.GetAll()));
            }
