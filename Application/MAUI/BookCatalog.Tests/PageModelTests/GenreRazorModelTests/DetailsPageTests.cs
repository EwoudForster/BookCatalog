...
namespace BookCatalog.Tests.PageModelTests.GenreRazorModelTests
{
    public class DetailsPageTests
    {
        ...
        [Fact]
        public async Task Genres_Details_RazorPage_Valid()
        {
        ...
        [Fact]
        public async Task Genres_Details_RazorPage_NotValid_NotFoundException()
        {
        ...
        [Fact]
        public async Task Genres_Details_RazorPage_NotValid_GeneralException()
        {
