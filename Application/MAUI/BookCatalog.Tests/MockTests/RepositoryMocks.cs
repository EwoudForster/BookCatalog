    ...
    public static class RepositoryMocks
    {
        public static readonly List<Book> MockBookList = new()
     {
        ...
        public static Mock<IBookRepository> GetBookRepository()
        {
            ...
            // Mock GetAll method
            mockBookRepository.Setup(repo => repo.GetAll(false)).ReturnsAsync(MockBookList);
        ...
        public static Mock<IGenreRepository> GetGenreRepository()
        {
            ...
            // Mock GetAll method
            mockGenreRepository.Setup(repo => repo.GetAll(false)).ReturnsAsync(MockBookList.SelectMany(book => book.Genres).Distinct());
            mockGenreRepository
        ...
        public static Mock<IPublisherRepository> GetPublisherRepository()
        {
            ...
            mockPublisherRepository.Setup(repo => repo.GetAll(false)).ReturnsAsync(MockBookList.Select(a => a.Publisher));
