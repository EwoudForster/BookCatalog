...
public static class LoggingStrings
{
    ...
    public static string InfoRetrievedStatistitics()
    {
        return $"📦 Retrieved the statistics";
    }
    ...
    public static string? InfoGuidCreated(Guid id)
    {
    ...
    // statistics
    public static string? InfoGettingTheStatistics()
    {
        return $"📊 Getting the statistics of the bookcatalog";
    }
