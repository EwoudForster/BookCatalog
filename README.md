...
## Table of Contents
  ...
  - [BookCatalog .NET Application Suite](bookcatalog-net-application-suite)
      ...
      - [Project Architecture](project-architecture)
          ...
          - [.NET MAUI Mobile Application](net-maui-mobile-application)
          - [Core Principles & Design Patterns](core-principles--design-patterns)
      ...
      - [Usage](usage)
          - [Web Application (ASP.NET Core)](web-application-aspnet-core)
              - [Home Page](home-page)
              - [Authentication & Authorization](authentication--authorization)
              - [Books Management](books-management)
              - [Categories Management (Genres, Authors, Publishers, More Info)](categories-management-genres-authors-publishers-more-info)
              - [Order Management (Admin Only)](order-management-admin-only)
              - [Search Page](search-page)
          - [Mobile Application (.NET MAUI)](mobile-application-net-maui)
              - [Language Localization](language-localization)
              - [Home Page & Initial Access](home-page--initial-access)
              - [Books Overview & Search](books-overview--search)
              - [Book Details & Cart Functionality](book-details--cart-functionality)
      ...
      - [Code Structure & Development](code-structure--development)
